defmodule MyAwesomeAppWeb.UserAuthTest do
  use MyAwesomeAppWeb.ConnCase, async: true

  alias MyAwesomeApp.Accounts
  alias MyAwesomeAppWeb.UserAuth
  import MyAwesomeApp.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MyAwesomeAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MyAwesomeAppWeb.Endpoint.subscribe(live_socket_id)
